...
public class ListViewForScrollViewRefresh extends LinearLayout {

	private ProductAdapter productAdapter;
	
	private ListViewOnItemClick click;
	
	public ListViewForScrollViewRefresh(Context context) {
		super(context);
		// TODO Auto-generated constructor stub
		IniAttr(null);
	}
	
	public  ListViewForScrollViewRefresh(Context context,AttributeSet attrs) {
		super(context,attrs);
		// TODO Auto-generated constructor stub
		IniAttr(attrs);
	}
		...
		for (int i = 0; i < count; i++) {
			...
			view.setOnClickListener(new OnClickListener() {				
				...
				public void onClick(View v) {
					// TODO Auto-generated method stub
					click.OnClick(ListViewForScrollViewRefresh.this, layout, index, index);
				}
			});
			addView(view, i);
		}
